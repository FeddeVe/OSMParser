...
extern "C" {
extern const ::google::protobuf::internal::DescriptorTable descriptor_table_osmformat_2eproto;
}  // extern "C"
namespace OSMPBF {
...
inline const ::google::protobuf::RepeatedPtrField<std::string>& HeaderBlock::required_features() const
    ABSL_ATTRIBUTE_LIFETIME_BOUND {
...
inline const ::google::protobuf::RepeatedPtrField<std::string>& HeaderBlock::optional_features() const
    ABSL_ATTRIBUTE_LIFETIME_BOUND {
...
inline const ::google::protobuf::RepeatedPtrField<std::string>& StringTable::s() const
    ABSL_ATTRIBUTE_LIFETIME_BOUND {
